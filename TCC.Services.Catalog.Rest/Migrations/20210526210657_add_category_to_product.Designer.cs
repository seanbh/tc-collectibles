...
namespace TCC.Services.Catalog.Rest.Migrations
{
    ...
    [Migration("20210526210657_add_category_to_product")]
    partial class add_category_to_product
    {
            ...
            modelBuilder.Entity("TCC.Services.Catalog.Rest.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Price = 65m,
                            Year = new DateTime(2021, 11, 26, 16, 6, 57, 473, DateTimeKind.Local).AddTicks(3768)
                        },
                        new
                        {
                            ...
                            Price = 85m,
                            Year = new DateTime(2022, 2, 26, 16, 6, 57, 475, DateTimeKind.Local).AddTicks(714)
                        },
                        new
                        {
                            ...
                            Price = 85m,
                            Year = new DateTime(2021, 9, 26, 16, 6, 57, 475, DateTimeKind.Local).AddTicks(753)
                        },
                        new
                        {
                            ...
                            Price = 25m,
                            Year = new DateTime(2021, 9, 26, 16, 6, 57, 475, DateTimeKind.Local).AddTicks(768)
                        },
                        new
                        {
                            ...
                            Name = "Techorama 2021",
                            Price = 400m,
                            Year = new DateTime(2022, 3, 26, 16, 6, 57, 475, DateTimeKind.Local).AddTicks(781)
                        },
                        new
                        {
                            ...
                            Price = 135m,
                            Year = new DateTime(2022, 1, 26, 16, 6, 57, 475, DateTimeKind.Local).AddTicks(795)
                        });
                });

            modelBuilder.Entity("TCC.Services.Catalog.Rest.Entities.Product", b =>
                {
                    b.HasOne("TCC.Services.Catalog.Rest.Entities.Category", "Category")
                        .WithMany("Products")
